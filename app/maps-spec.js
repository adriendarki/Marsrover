...
describe('Map', function() {
	...
	it('validates a valid position', function() {
		var map = new Map(2, 2);
	...
	it('rejects a colliding rover move', function() {
		var map = new Map(3, 3);
		map.addRover(new Rover('nord', 1, 2));
		var roverId = map.addRover(new Rover('ouest', 2, 2));
	...
	it('rejects a rover move that goes off the map', function() {
		var map = new Map(3, 3);
		var roverId = map.addRover(new Rover('nord', 3, 3));
		expect(moveRover).toThrow();
